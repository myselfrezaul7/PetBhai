...
const updates = [
  { id: 63, imageUrl: '/blog-images/blog-microchip.png' },
  { id: 67, imageUrl: '/blog-images/blog-dog-stairs.png' },
  { id: 68, imageUrl: '/blog-images/blog-cat-acne.png' },
  { id: 69, imageUrl: '/blog-images/blog-pet-insurance.png' },
  { id: 70, imageUrl: '/blog-images/blog-pet-names.png' },
];
...
console.log('Updated batch 2 thumbnails');
