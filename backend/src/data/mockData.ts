...
export const MOCK_ARTICLES: any[] = [
  {
    id: 45,
    image: '/blog-images/blog-desi-eye-care.png',
  ...
  {
    id: 52,
    image: '/blog-images/blog-desi-dog-ear.png',
  ...
  {
    id: 55,
    image: '/blog-images/blog-desi-dog-bark.png',
  ...
  {
    id: 63,
    image: '/blog-images/blog-desi-microchip.png',
  ...
  {
    id: 67,
    image: '/blog-images/blog-desi-dog-stairs.png',
  ...
  {
    id: 1005,
    image: '/blog-images/blog-desi-dog.png',
...
প্রতিবার খাওয়ানোর পর একটি হালকা গরম ভেজা তুলো দিয়ে ছানার মলদ্বার ও মূত্রনালীর চারপাশে আলতো করে ঘষে দিন। মা বিড়াল চাটলে যেমন হয়, এটি ঠিক তেমন কাজ করে এবং ছানাকে মলমূত্র ত্যাগে সাহায্য করে। এটি না করলে ছানার পেট ফুলে মারা যেতে পারে।`,
    imageUrl: '/blog-images/stray_kitten_alone_1781879134097.png',
    author: 'PetBhai Team',
...
> গাছ নিরাপদ হলেও প্রাণীদের মাটি খোঁড়া বা পাতা চিবানোর অভ্যাস থাকে। তাই গাছগুলোকে কিছুটা উঁচুতে বা হ্যাঙ্গিং পটে রাখা ভালো।`,
  ...
  {
    id: 207,
    image: '/blog-images/blog-child-dog-safety.png',
  ...
  },
  {
    ...
    content: `## পোষা প্রাণীর খিঁচুনি কী এবং কেন হয়?

কুকুর বা বিড়ালের মস্তিষ্কের স্নায়বিক কার্যকলাপের আকস্মিক ও অস্বাভাবিক পরিবর্তনের কারণে খিঁচুনি (Seizure) হয়ে থাকে। এটি মৃগীরোগ (Epilepsy), বিষক্রিয়া (Toxins), অতিরিক্ত জ্বর, মাথায় আঘাত, রক্তের গ্লুকোজ কমে যাওয়া বা লিভার/কিডনি সমস্যার কারণে হতে পারে।

খিঁচুনি শুরুর আগে প্রাণীটি কিছুটা অস্থির হতে পারে, লুকানোর চেষ্টা করতে পারে বা বেশি লালা ঝরাতে পারে (যাকে 'Aura' পর্যায় বলা হয়)। এরপর শরীর শক্ত হয়ে যাওয়া, হাত-পা অনিয়ন্ত্রিতভাবে ঝাঁকানো, মুখ দিয়ে ফেনা বের হওয়া এবং মল-মূত্র ত্যাগ করার মতো লক্ষণ প্রকাশ পায়।

### ⚡ খিঁচুনি চলাকালীন বাড়িতে তাৎক্ষণিক করণীয়

১. **নিজে শান্ত থাকুন:** আতঙ্কিত হলে পোষা প্রাণীর ক্ষতি হতে পারে। নিজেকে শান্ত রাখুন যাতে আপনি দ্রুত সঠিক সিদ্ধান্ত নিতে পারেন।
২. **আশেপাশের পরিবেশ নিরাপদ করুন:** প্রাণীর আশেপাশের শক্ত, ধারালো বা ভারী বস্তু সরিয়ে নিন যাতে ঝাঁকুনির সময় আঘাত না লাগে। সে যদি খাট, সোফা বা সিঁড়ির কাছাকাছি থাকে, তবে আলতো করে মেঝেতে নামিয়ে আনুন।
৩. **সময় নোট করুন:** খিঁচুনি ঠিক কখন শুরু হলো এবং কতক্ষণ স্থায়ী হলো তা ঘড়ি দেখে নিখুঁতভাবে সময় গণনা করুন। যদি খিঁচুনি ২-৩ মিনিটের বেশি স্থায়ী হয়, তবে এটি 'Status Epilepticus' হতে পারে যা একটি চরম প্রাণঘাতী জরুরি অবস্থা।
৪. **আলো ও শব্দ কমান:** ঘরের উজ্জ্বল আলো নিভিয়ে দিন, ফ্যানের বা টিভি-র শব্দ কমিয়ে একটি শান্ত ও অন্ধকার পরিবেশ তৈরি করুন।
৫. **ভিডিও রেকর্ড করুন (সম্ভব হলে):** খিঁচুনির সময় লক্ষণগুলোর ছোট একটি ভিডিও ফোনে ধারণ করে রাখুন, যা পরবর্তীতে ভেটেরিনারিয়ানকে রোগ নির্ণয়ে সহায়তা করবে।

### ❌ যে ভুলগুলো কখনোই করবেন না

* **মুখে হাত দেবেন না:** কখনোই খিঁচুনি চলাকালীন প্রাণীর মুখের ভেতর হাত দেবেন না বা জিহ্বা টেনে বের করার চেষ্টা করবেন না। কুকুর বা বিড়ালের জিহ্বা গিলে ফেলার সম্ভাবনা থাকে না, কিন্তু অবচেতন কামড়ে আপনার হাত মারাত্মক ক্ষতবিক্ষত হতে পারে।
* **জোর করে চেপে ধরবেন না:** শরীর শক্ত করে চেপে ধরে ঝাঁকুনি থামানোর চেষ্টা করবেন না, এতে প্রাণীর হাড় বা পেশিতে টান পড়তে পারে।
* **মুখে পানি বা ওষুধ দেবেন না:** খিঁচুনির সময় মুখে কোনো পানি, খাবার বা ওষুধ দেওয়ার চেষ্টা করবেন না, কারণ এটি ফুসফুসে ঢুকে গিয়ে চোকিং বা এসপিরেশন নিউমোনিয়া ঘটাতে পারে।

### খিঁচুনি থামার পর করণীয় (Post-ictal Phase)

খিঁচুনি শেষ হওয়ার পর প্রাণীটি সাময়িকভাবে অন্ধত্ব, বিভ্রান্তি, অতিরিক্ত ক্লান্তি বা উদ্দেশ্যহীনভাবে হাঁটাহাঁটি করতে পারে। 
- নরম কম্বল দিয়ে তাকে ঢেকে উষ্ণ রাখুন।
- তার সাথে শান্ত ও আশ্বস্তকর গলায় কথা বলুন।
- সামান্য পানি দিতে পারেন, তবে জোর করবেন না।

> **জরুরি সতর্কবার্তা:** খিঁচুনি যদি ৫ মিনিটের বেশি স্থায়ী হয়, অথবা ২৪ ঘণ্টার মধ্যে একাধিকবার হয়, কিংবা বিষ খাওয়ার সন্দেহ থাকে—তবে এক মুহূর্তও দেরি না করে অবিলম্বে নিকটস্থ রেজিস্টার্ড ভেটেরিনারি হসপিটালে নিয়ে যান।`,
    excerpt:
      'পোষা প্রাণীর হঠাৎ খিঁচুনি দেখলে আতঙ্কিত হবেন না। খিঁচুনি চলাকালীন নিরাপত্তা নিশ্চিত করা, সময় ট্র্যাক করা এবং জরুরি ভেটেরিনারি কেয়ারের পূর্ণাঙ্গ নির্দেশিকা।',
    author: 'PetBhai Team',
    date: '2026-05-01',
    readTime: 4,
    imageUrl: '/blog-images/blog-seizure-care.png',
