  ...
  return (
    <main className="container mx-auto px-6 py-20 text-center min-h-[60vh] flex flex-col items-center justify-center">
      <div className="glass-card-ios p-12 max-w-2xl relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 -mt-10 -ml-10 w-40 h-40 bg-amber-400 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
        ...
        <PawIcon className="w-20 h-20 text-amber-500 mb-6 mx-auto animate-pulse" />
        <h1 className="text-4xl md:text-5xl font-extrabold text-slate-800 dark:text-white mb-4">
          Online Consultation
        </h1>
        <h2 className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-cyan-500 mb-6">
          Coming Soon
        </h2>
