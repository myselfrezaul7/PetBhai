    ...
    <main className="w-full pb-[calc(6.5rem+env(safe-area-inset-bottom))] md:pb-12">
      <section className="container mx-auto px-4 pb-6 pt-4 md:px-6 md:pb-10 md:pt-8" aria-label="Hero banner">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[2.1rem] border border-amber-900/10 dark:border-amber-100/10 p-4 shadow-[0_22px_40px_rgba(0,0,0,0.05)] dark:shadow-[0_22px_40px_rgba(0,0,0,0.5)] md:p-8"
        >
          <img
          ...
          <div className="relative z-10 flex min-h-[15.5rem] items-end sm:min-h-[17rem]">
            <div className="w-full max-w-[17.5rem] rounded-[1.6rem] border border-amber-900/10 dark:border-amber-100/10 bg-white/95 dark:bg-zinc-900/95 dark:bg-black/20 p-5 text-white backdrop-blur-md">
              ...
              <Link
                to="/shop"
                className="mt-5 inline-flex min-h-[44px] w-full items-center justify-center rounded-full bg-gradient-to-r from-amber-500 to-amber-600 px-4 text-xl font-semibold text-white shadow-lg shadow-amber-900/30 transition-all duration-300 hover:scale-[1.02] active:scale-95"
              >
                Explore Now
              </Link>
            </div>
