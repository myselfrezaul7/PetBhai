    ...
    <div className="w-full">
      ...
      <section className="py-12 md:py-20 animate-fade-in" style={{ animationDelay: '100ms' }}>
        <div className="container mx-auto px-3 md:px-6">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-2xl md:text-4xl font-bold text-slate-800 dark:text-white mb-2 md:mb-4">{t('section_best_sellers')}</h2>
        ...
        <div className="container mx-auto px-4 md:px-6">
             <div className="glass-card p-0 overflow-hidden flex flex-col md:flex-row-reverse items-center">
                ...
                <div className="md:w-1/2 p-6 md:p-16 text-center md:text-left">
                    <h2 className="text-2xl md:text-5xl font-bold text-slate-800 dark:text-white leading-tight">{t('section_services_title')}</h2>
      ...
      <section className="py-10 md:py-16 animate-fade-in" style={{ animationDelay: '300ms' }}>
          <div className="container mx-auto px-4 md:px-6 text-center">
              <h2 className="text-lg md:text-2xl font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-8 md:mb-10">{t('section_brands')}</h2>
              <div className="flex flex-wrap justify-center items-center gap-6 md:gap-12 opacity-80 hover:opacity-100 transition-opacity">
                  {MOCK_BRANDS.map(brand => (
                      <Link key={brand.id} to="/shop" state={{ brand: brand.name }} className="grayscale hover:grayscale-0 transition-all duration-300 transform hover:scale-110">
                          <img src={brand.logoUrl} alt={brand.name} className="h-8 md:h-14 w-auto object-contain" />
                      </Link>
                  ))}
              </div>
          </div>
      ...
      <section className="py-12 md:py-20 bg-white/50 dark:bg-black/20 backdrop-blur-sm animate-fade-in" style={{ animationDelay: '400ms' }}>
        <div className="container mx-auto px-3 md:px-6 text-center">
          <h2 className="text-2xl md:text-4xl font-bold text-slate-800 dark:text-white mb-2 md:mb-4">{t('section_new_arrivals')}</h2>
      ...
      <section className="py-12 md:py-20 animate-fade-in" style={{ animationDelay: '500ms' }}>
        <div className="container mx-auto px-4 md:px-6">
          <div className="glass-card text-center p-8 md:p-20 bg-gradient-to-br from-yellow-100/50 to-orange-100/50 dark:from-yellow-900/20 dark:to-orange-900/20 border-orange-200 dark:border-orange-800/30">
            <h2 className="text-2xl md:text-5xl font-extrabold text-slate-800 dark:text-white mb-4 md:mb-6">{t('section_plus_title')}</h2>
