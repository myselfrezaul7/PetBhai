...
const ProductDetailPage: React.FC = () => {
  ...
  const StarRatingDisplay: React.FC<{ rating: number; className?: string }> = ({
    rating,
    className = 'w-5 h-5',
  }) => (
        ...
        <div className="glass-card overflow-hidden lg:flex">
          ...
          <div className="p-8 lg:w-1/2 flex flex-col">
            <div>
              ...
              <p className="text-4xl font-bold text-slate-800 dark:text-white my-4">
                ৳{product.price}
              </p>
            ...
            <div className="mt-6 bg-slate-100/50 dark:bg-slate-800/50 p-4 rounded-lg">
              ...
              <button className="mt-2 text-sm font-bold text-orange-600 hover:underline">
                Learn More
              </button>
            </div>
        ...
        <div className="glass-card mt-12 p-8">
          ...
          {isAuthenticated && currentUser ? (
            <form
              ...
              className="mb-8 p-6 bg-slate-100/50 dark:bg-slate-800/50 rounded-lg"
            >
              <div className="flex items-start space-x-4">
                ...
                <div className="flex-grow">
                  ...
                  <button
                    type="submit"
                    className="mt-2 bg-orange-500 text-white font-bold py-2 px-6 rounded-lg hover:bg-orange-600"
                  >
                    Submit Review
                  </button>
                </div>
