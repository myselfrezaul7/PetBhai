          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="pt-4">
              ...
              <div className="space-y-3">
                <label
                  className={`flex items-center p-4 border rounded-lg cursor-pointer transition-all ${paymentMethod === 'cod' ? 'border-orange-500 ring-2 ring-orange-500' : 'border-slate-300 dark:border-slate-600'}`}
                >
                  <input
                    type="radio"
                    name="paymentMethod"
            ...
            <div className="pt-4">
              <button
                type="submit"
                className="w-full bg-orange-500 text-white font-bold py-3 px-4 rounded-lg text-lg hover:bg-orange-600 transition-colors"
              >
                Place Order
              </button>
            </div>
          ...
          <div className="space-y-4 max-h-80 overflow-y-auto pr-2">
            {cartItems.map((item) => (
              <div key={item.id} className="flex justify-between items-start">
                ...
                <p className="font-semibold text-slate-700 dark:text-slate-200 text-right shrink-0 ml-4">
