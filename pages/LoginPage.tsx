...
const LoginPage: React.FC = () => {
  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent) => {
      ...
      if (emailError || passwordError || mathError) {
        setFieldErrors({ email: emailError, password: passwordError, mathAnswer: mathError });
        if (!hasRecaptcha) {
  ...
  return (
    <main className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 flex-grow flex items-center justify-center">
          ...
          {showMathFallback && (
            <div className="rounded-lg border border-amber-300 bg-amber-50 p-3 dark:border-amber-500/40 dark:bg-amber-500/10">
              ...
              <input
                ...
                aria-invalid={!!fieldErrors.mathAnswer}
