...
const translations: Translations = {
    ...
    // Home Page
    hero_title: { en: 'A Loving Home For Every Animal', bn: 'আদরের পোষ্যের জন্য ভালোবাসা ও নিরাপদ আশ্রয়' },
    hero_subtitle: { 
    ...
    section_best_sellers_sub: { en: 'Loved by pets and their parents.', bn: 'প্যারেন্টস এবং তাদের আদরের পোষ্যদের পছন্দের তালিকায় সেরা পণ্যগুলো।' },
    ...
    section_new_arrivals_sub: { en: 'The latest and greatest products, fresh in our store.', bn: 'আমাদের সংগ্রহে সদ্য যোগ হওয়া এক্সক্লুসিভ সব পণ্য।' },
    ...
    blog_page_subtitle: { en: 'Get expert advice on pet care, nutrition, training, and new product news.', bn: 'বিশেষজ্ঞদের পরামর্শ, টিপস আর নতুন সব খবর জানুন—আপনার পোষ্যের সুস্থ জীবনের জন্য।' },
    ...
    article_not_found_desc: { en: 'The article you are looking for might have been removed or the link is incorrect.', bn: 'আপনি যে লেখাটি খুঁজছেন তা হয়তো সরানো হয়েছে অথবা লিংকটি ভুল।' },
    ...
    article_generate_image_desc: { en: 'Click the button to create a unique AI-generated image for this article.', bn: 'এই আর্টিকেলের জন্য AI দিয়ে নতুন একটি ছবি তৈরি করতে নিচের বাটনে ক্লিক করুন।' },
