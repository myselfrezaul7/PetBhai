        ...
        <div className="p-8">
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none text-slate-700 dark:text-slate-300">
            <p>
              ...
              experience on our website. We use them for various purposes, which are explained
              below.
            </p>
            ...
            <p>
              ...
              you, such as logging in or filling in forms. You can choose "Necessary only" to use
              just these.
            </p>
            <ul>
              <li>
                <strong>Shopping Cart:</strong> We use local storage (similar to a cookie) to
                remember the items you've added to your cart, so they're still there when you
                return.
              </li>
              <li>
                <strong>Session Management:</strong> To keep you logged in as you navigate the site.
              </li>
              <li>
                <strong>Consent Preference:</strong> To remember your cookie consent choice so we
                don't ask you again.
              </li>
            </ul>

            <h3 className="text-slate-800 dark:text-white">
              Analytics & Functional Cookies (Optional)
            </h3>
            <p>
              These cookies allow us to enable additional functionality and personalization. They
              ...
              function properly. You can enable these by choosing "Accept all".
            </p>
            <ul>
              <li>
                <strong>Third-Party Features:</strong> Enabling tools like the Facebook Messenger
                chat plugin for live support.
              </li>
              <li>
                <strong>Analytics:</strong> Collecting anonymous data about how visitors use our
                site, which helps us improve our services (we plan to add this in the future).
              </li>
            </ul>
