        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <a
              ...
              className="flex items-center justify-center md:justify-start space-x-2 text-slate-700 dark:text-slate-200 hover:text-orange-500 dark:hover:text-orange-400 transition-colors"
            >
          ...
          <div>
            <h3 className="font-bold text-slate-800 dark:text-white text-lg mb-4 uppercase tracking-wider">
              Follow Us
            </h3>
