    ...
    <div className="glass-card overflow-hidden">
        ...
        {isEditing ? (
          <div>
            ...
            <div className="flex justify-end space-x-2 mt-2">
              <button onClick={() => setIsEditing(false)} className="text-sm font-semibold">
                Cancel
              </button>
              <button
                onClick={handleUpdate}
                className="text-sm font-bold text-white bg-orange-500 px-3 py-1 rounded-md"
              >
                Save
              </button>
            </div>
      ...
      <div className="px-6 py-3 border-y border-white/20 dark:border-slate-700/50 flex justify-around">
        ...
        <button
          ...
          className="flex items-center space-x-2 text-slate-600 dark:text-slate-300 hover:text-orange-600 font-semibold transition-colors rounded-lg px-4 py-2 hover:bg-orange-50/50 dark:hover:bg-slate-700/50"
        >
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <button
                      ...
                      className="text-xs font-semibold text-slate-600 dark:text-slate-400 mt-1 hover:underline"
                    >
                      Reply
                    </button>
                  </div>
