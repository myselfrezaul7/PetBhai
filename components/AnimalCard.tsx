...
const AnimalCard: React.FC<AnimalCardProps> = ({ animal }) => {
  ...
  return (
    <div className="group flex h-full card-virtualized flex-col overflow-hidden rounded-3xl border border-amber-900/10 dark:border-amber-100/10 bg-white/95 dark:bg-zinc-900/95 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg dark:border-amber-100/10 dark:bg-zinc-900/95">
      <div className="relative overflow-hidden aspect-[4/3]">
        ...
        <div
          className={`absolute left-2 top-2 rounded-full px-2.5 py-1 text-xs font-bold shadow-sm sm:left-3 sm:top-3 sm:px-3 sm:py-1 ${statusColors[animal.status]}`}
        >
          {animal.status}
        </div>
        <button
          ...
          className={`absolute right-2 top-2 flex min-h-[44px] min-w-[44px] items-center justify-center rounded-full transition-all duration-300 shadow-md hover:scale-110 active:scale-90 touch-manipulation sm:right-3 sm:top-3
                ${
                  isFavorited
                    ...
                    : 'border border-amber-900/10 dark:border-amber-100/10 bg-white/95 dark:bg-zinc-900/95 text-slate-700 hover:text-amber-600 dark:text-amber-500 dark:border-amber-100/10 dark:bg-zinc-900/95 dark:text-zinc-300'
                }`}
      ...
      <div className="p-3 sm:p-5 flex flex-col flex-grow">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-zinc-500 dark:text-zinc-300 font-medium text-xs sm:text-sm mt-0.5 sm:mt-1 line-clamp-1">
              {animal.breed}
            </p>
          </div>
        ...
        <div className="mt-1 sm:mt-4 pt-1 sm:pt-4 border-t border-amber-900/10 dark:border-amber-100/10 dark:border-amber-900/5 dark:border-amber-100/5 flex flex-wrap items-center justify-between text-xs sm:text-sm text-zinc-500 dark:text-zinc-300 gap-1">
        ...
        <p className="text-zinc-500 dark:text-zinc-300 mt-1 sm:mt-4 flex-grow text-xs sm:text-sm line-clamp-2 leading-relaxed">
          {animal.description}
        </p>
      </div>
      <div className="mt-auto border-t border-amber-900/10 dark:border-amber-100/10 bg-slate-50 p-2 dark:border-amber-100/10 dark:bg-zinc-900/95 sm:p-4">
        <Link
          to={`/adopt/${animal.id}`}
