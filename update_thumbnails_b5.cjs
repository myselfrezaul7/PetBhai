...
const updates = [
  { id: 101, imageUrl: '/blog-images/blog-tick-flea.png' },
  { id: 102, imageUrl: '/blog-images/blog-dog-feeding.png' },
  { id: 103, imageUrl: '/blog-images/blog-desi-immunity.png' },
  { id: 104, imageUrl: '/blog-images/blog-dog-summer.png' },
  { id: 105, imageUrl: '/blog-images/blog-dog-crying.png' },
];
...
console.log('Updated batch 5 thumbnails');
