...
exports.MOCK_USERS = exports.MOCK_ANIMALS = exports.MOCK_ARTICLES = exports.MOCK_VETS = exports.MOCK_POSTS = exports.MOCK_PRODUCTS = exports.MOCK_BRANDS = void 0;
exports.MOCK_BRANDS = [
    // Row 1
    {
        id: 3,
...
exports.MOCK_PRODUCTS = [
    {
        ...
        description: 'A delicious and nutritious tuna-flavored dry food for adult cats of all breeds. Enriched with vitamins and minerals for a healthy life. A popular choice for cat owners in Bangladesh.',
        weight: '7kg',
        brandId: 4,
        rating: 4.8,
    ...
    },
    {
        ...
        description: 'Specially formulated for puppies to support their growth and development with essential nutrients, prebiotics and probiotics. Highly recommended by vets.',
        weight: '3kg',
        brandId: 3,
        rating: 4.5,
        reviews: [
    ...
    },
    {
        ...
        description: 'Whiskas Ocean Fish is a complete and balanced dry food for adult cats. It supports healthy skin and a shiny coat. Very popular in Dhaka.',
        weight: '1.2kg',
        brandId: 5,
        rating: 4.6,
        reviews: [],
    ...
    },
    {
        ...
        description: 'SmartHeart Adult Cat Food is formulated to meet adult cat nutritional requirements. Enriched with DHA and EPA.',
        weight: '1.2kg',
        brandId: 6,
        rating: 4.5,
        reviews: [],
    ...
    },
    {
        ...
        description: 'Delicious chunks with salmon for adult cats. Let your cat enjoy this crispy food. A premium choice available in Bangladesh.',
        weight: '2kg',
        brandId: 7,
        rating: 4.4,
        reviews: [],
    ...
    },
    {
        ...
        description: 'High energy formula for active puppies. Promotes muscle mass and proper structure.',
        weight: '3kg',
        brandId: 6,
        rating: 4.7,
        reviews: [],
    ...
    },
    {
        ...
        description: 'High-quality stainless steel bowl with a rubber base to prevent sliding and tipping. Easy to clean.',
        weight: 'Medium',
        brandId: 16,
    ...
    },
    {
        ...
        description: 'Save your furniture! Durable sisal rope scratching post that cats love to scratch. Includes a hanging toy.',
        weight: '1.5kg',
        brandId: 16,
        rating: 4.7,
        reviews: [],
    ...
    },
    {
        ...
        description: 'Ultra-soft fleece bed for cats and small dogs. Machine washable and very cozy for winter.',
        weight: 'Size M',
        brandId: 16,
        rating: 4.8,
        reviews: [],
    ...
    },
    {
        ...
        description: 'Super premium cat food with chicken. Xylo-oligosaccharides (XOS) super prebiotics for digestion.',
        weight: '8kg',
        brandId: 9,
        rating: 4.9,
        reviews: [],
    ...
    },
    {
        ...
        description: 'Bulk pack of Bonnie Adult Cat Food. Great value for multi-cat households. Chicken flavor.',
        weight: '10kg',
        brandId: 13,
        rating: 4.4,
        reviews: [],
    ...
    },
    {
        ...
        description: 'Drools Chicken and Egg formula provides complete nutrition. Real chicken meat and egg.',
        weight: '3kg',
        brandId: 3,
        rating: 4.5,
        reviews: [],
    ...
    },
    {
        ...
        description: 'JerHigh Meat as Meals is a premium semi-moist dog food suitable for all breeds. Soft texture.',
        weight: '500g',
        brandId: 15,
        rating: 4.9,
        reviews: [],
    ...
    },
    {
        ...
        description: 'High-quality Bentonite Cat Litter with pleasant scent (Lemon or Coffee). Strong clumping action.',
        weight: '5L',
        brandId: 16,
        rating: 4.3,
        reviews: [],
    ...
    },
    {
        ...
        description: 'Durable plastic litter box with removable rim to prevent spillage. Easy to clean.',
        weight: 'Medium',
        brandId: 16,
        rating: 4.4,
        reviews: [],
    ...
    },
    {
        ...
        description: 'Easily remove loose fur and tangles. One-click self-cleaning mechanism makes grooming a breeze.',
        weight: '1 unit',
        brandId: 16,
        rating: 4.7,
        reviews: [],
    ...
    },
    {
        ...
        description: 'Sturdy pet carrier cage suitable for cats and small dogs. Good ventilation and secure lock.',
        weight: 'Size S',
        brandId: 16,
        rating: 4.8,
        reviews: [],
    ...
    },
    {
        ...
        description: 'Sharp stainless steel blades for precise cutting. Safety guard to prevent over-cutting.',
        weight: '1 unit',
        brandId: 16,
        rating: 4.5,
        reviews: [],
...
const MOCK_ORDERS = [
    {
        ...
        total: 6450,
        items: [
            { ...exports.MOCK_PRODUCTS[0], quantity: 1 },
            { ...exports.MOCK_PRODUCTS[4], quantity: 1 },
        ],
        status: 'delivered',
    },
    {
        ...
        total: 1300,
        items: [{ ...exports.MOCK_PRODUCTS[1], quantity: 1 }],
        status: 'processing',
    },
    {
        ...
        date: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
        total: 480,
        items: [{ ...exports.MOCK_PRODUCTS[8], quantity: 1 }],
        status: 'shipped',
    },
];
const MOCK_COMMENTS = [
...
exports.MOCK_POSTS = [
    ...
    },
    {
        ...
        content: '뿯½뿯ƽ뿯½뿯½ Pro tip for new dog owners: Consistency is key in training! Start with basic commands like "sit" and "stay" and practice daily. My German Shepherd learned these in just 2 weeks. What training tips do you have?',
    ...
    },
    {
        ...
        content: 'Looking for recommendations for a good vet in Dhanmondi area. My kitten needs her first vaccination. Any suggestions would be greatly appreciated! 뿯½뿯ƽ뿯½뿯▽뿯½뿯ƽ뿯½뿯½',
...
const MOCK_VET_REVIEWS = [
    ...
    },
    {
        ...
        author: 'Jamal K.',
        rating: 5,
        comment: "Excellent online consultation. Dr. Islam gave me clear advice for my senior cat's diet.",
        date: new Date(Date.now() - 10 * 24 * 60 * 60 * 1000).toISOString(),
    },
];
exports.MOCK_VETS = [
...
exports.MOCK_ARTICLES = [
    ...
    },
    {
        ...
        excerpt: 'বিড়াল মুখে কথা বলতে না পারলেও তাদের লেজ দিয়ে অনেক কিছু বুঝিয়ে দেয়। বিড়ালের লেজ শুধু দেহের ভারসাম্য রক্ষার জন্য নয়, এটি তাদের অনুভূতির অন্যতম প্র...',
        category: 'Cat Care',
        tags: ['Cat'],
    ...
    },
    {
        ...
        excerpt: 'আমাদের সমাজে কালো বিড়াল নিয়ে অনেক ধরনের কুসংস্কার প্রচলিত আছে। রাস্তা পার হওয়ার সময় কালো বিড়াল সামনে পড়লে যাত্রা অশুভ—এমন ধারণা আজও অনেকেই বিশ্ব...',
        category: 'Cat Care',
        tags: ['Cat'],
    ...
    },
    {
        ...
        excerpt: 'শখের কুকুর বা বিড়াল হারিয়ে যাওয়ার কষ্ট অবর্ণনীয়। বকলস বা নামের ট্যাগ ছিঁড়ে যেতে পারে, কিন্তু মাইক্রোচিপ হলো একটি স্থায়ী সমাধান। এটি আপনার পোষ্যে...',
        category: 'General Pet Care',
        tags: ['Pet Care'],
    ...
    },
    {
        ...
        excerpt: 'অ্যাপার্টমেন্ট বা ফ্ল্যাট বাসায় যারা কুকুর পালেন, তাদের নিয়মিত লিফট বা সিঁড়ি ব্যবহার করতে হয়। অনেক কুকুর লিফটে ভয় পায় বা সিঁড়িতে লাফিয়ে নামার ...',
        category: 'Dog Care',
        tags: ['Dog'],
    ...
    },
    {
        ...
        excerpt: 'মানুষের মতো বিড়ালেরও থুতনিতে ব্রন বা একনে হতে পারে। এটি তেমন বিপজ্জনক কিছু নয়, তবে অবহেলা করলে এটি ইনফেকশনে রূপ নিতে পারে এবং বিড়ালের অনেক অস্বস্তি...',
        category: 'Cat Care',
        tags: ['Cat'],
    ...
    },
    {
        ...
        excerpt: 'মানুষের যেমন স্বাস্থ্য বীমা বা ইনস্যুরেন্স থাকে, তেমনি উন্নত দেশগুলোতে পোষা প্রাণীর চিকিৎসার খরচ মেটানোর জন্য পেট ইনস্যুরেন্স மிகவும் জনপ্রিয়। বাংলাদ...',
        category: 'General Pet Care',
        tags: ['Pet Care'],
    ...
    },
    {
        ...
        excerpt: 'পরিবারে নতুন একটি কুকুরছানা বা বিড়ালছানা আনলে সবচেয়ে প্রথম যে উত্তেজনা কাজ করে তা হলো—তার নাম কী রাখবো? একটি নাম শুধু পরিচয়ই নয়, সেটি তার ট্রেইনিং...',
        category: 'Dog Care',
        tags: ['Dog', 'Cat'],
    ...
    },
    {
        ...
        excerpt: 'মানুষের মতো কুকুরদেরও বৃদ্ধ বয়স আসে এবং তখন তাদের শরীর ও মনে অনেক পরিবর্তন ঘটে। সাধারণত ৭-৮ বছর বয়সের পর বড় জাতের কুকুর এবং ১০-১২ বছরের পর ছোট জাতে...',
        category: 'Dog Care',
        tags: ['Dog'],
    ...
    },
    {
        ...
        excerpt: "যারা বিড়াল পালেন তারা প্রায় সবাই 'হেয়ারবল' (Hairball) বা লোমের গোলার সাথে পরিচিত। বিড়াল যখন বমি করে লোমের একটি নলাকার দলা বের করে দেয়, তখনই তাকে ...",
        category: 'Cat Care',
        tags: ['Cat'],
    ...
    },
    {
        ...
        excerpt: 'রাস্তায় অযত্ন আর অবহেলায় ঘুরে বেড়ানো একটি ভাসমান বিড়ালকে (Stray Cat) উদ্ধার করে বাড়িতে আশ্রয় দেওয়া একটি মহৎ কাজ। বিদেশী দামি বিড়াল না কিনে একট...',
        category: 'Cat Care',
        tags: ['Cat'],
    ...
    },
    {
        ...
        excerpt: 'কুকুর ডাকবে এটাই স্বাভাবিক, কিন্তু যখন তা মাত্রা ছাড়িয়ে যায় এবং অকারণে ঘেউ ঘেউ শুরু করে, তখন গৃহকর্তা এবং প্রতিবেশী—সবার জন্যই তা বিরক্তির কারণ হয়...',
        category: 'Dog Care',
        tags: ['Dog'],
    ...
    },
    {
        ...
        excerpt: 'বৃষ্টির দিনগুলো সবার জন্যই আরামদায়ক হলেও, আপনাদের শখের কুকুর বা বিড়ালের জন্য বর্ষাকাল বেশ কিছু স্বাস্থ্যঝুঁকি বয়ে আনে। এই সময়ে ফাঙ্গাস, টিক, ফ্লি ...',
        category: 'General Pet Care',
        tags: ['Pet Care'],
    ...
    },
    {
        ...
        excerpt: 'পোষা কুকুর লালনপালন করতে চাইলে প্রথমেই যে প্রশ্নটি আসে তা হলো— বিদেশি কোনো ব্রিড কিনব নাকি দেশি কুকুর দত্তক নেব? বাংলাদেশের প্রেক্ষাপটে অনেকেই না বুঝে...',
        category: 'Dog Care',
        tags: ['Dog'],
    ...
    },
    {
        ...
        excerpt: 'বাড়িতে একটি ছোট কুকুরছানা (Puppy) আসার পরপরই তাকে ট্রেইনিং দেওয়া শুরু করা অত্যন্ত গুরুত্বপূর্ণ। ছোটবেলার ভালো অভ্যাসগুলোই তাকে পরবর্তীতে একটি বাধ্য ...',
        category: 'Dog Care',
        tags: ['Dog'],
...
একেবারেই না! রোগ প্রতিরোধ ক্ষমতা বেশি হলেও তাদের টিকা (ভ্যাকসিন) এবং কৃমির ওষুধ দেওয়া বাধ্যতামূলক। সঠিক খাবার এবং ভালোবাসা পেলে একটি দেশি কুকুর ১৫-১৬ বছর পর্যন্ত সুস্থভাবে বাঁচতে পারে।`,
        ...
        excerpt: 'দেশি কুকুরের রোগ প্রতিরোধ ক্ষমতা কেন বেশি?\n\nবিশেষজ্ঞ ভেটেরিনারিয়ানদের মতে, এই বিষয়টি অত্যন্ত গুরুত্বপূর্ণ।\n\nপরিচ্ছন্নতা বজায় রাখা শুধুমাত্র তাদের জ...',
        category: 'Dog Care',
        tags: ['Dog'],
    ...
    },
    {
        ...
        excerpt: 'গরমে কুকুরকে সুস্থ ও সতেজ রাখতে করণীয়\n\nবিশেষজ্ঞ ভেটেরিনারিয়ানদের মতে, এই বিষয়টি অত্যন্ত গুরুত্বপূর্ণ।\n\nসঠিক ডায়েট এবং পুষ্টি তাদের ইমিউন সিস্টেমকে...',
        category: 'Dog Care',
        tags: ['Dog'],
...
কখনোই মানুষের কটন বাড (Q-tips) কুকুরের কানের ভেতর ঢোকাবেন না। এতে ময়লা আরও ভেতরে চলে যেতে পারে এবং কানের পর্দা মারাত্মকভাবে ক্ষতিগ্রস্ত হতে পারে। যদি কানে খুব দুর্গন্ধ থাকে বা কান লাল হয়ে যায়, তবে নিজে পরিষ্কার না করে ভেটকে দেখান।`,
        ...
        excerpt: 'কুকুরের কান পরিষ্কার করার সঠিক নিয়ম\n\nপোষা প্রাণীদের সুস্থ ও আনন্দময় জীবন নিশ্চিত করতে আমাদের কিছু নিয়ম মেনে চলতে হবে।\n\nপরিচ্ছন্নতা বজায় রাখা শুধুম...',
        category: 'Dog Care',
        tags: ['Dog'],
    ...
    },
    {
        ...
        excerpt: 'কুকুরের নখ কাটার সময় যে সতর্কতাগুলো মানতে হবে\n\nবিশেষজ্ঞ ভেটেরিনারিয়ানদের মতে, এই বিষয়টি অত্যন্ত গুরুত্বপূর্ণ।\n\nসঠিক ডায়েট এবং পুষ্টি তাদের ইমিউন স...',
        category: 'Dog Care',
        tags: ['Dog'],
...
বয়স্ক কুকুরের কিডনির কার্যক্ষমতা কমে যেতে পারে, তাই তাদের খাবারে লবণের পরিমাণ একদম কমিয়ে দিতে হবে এবং সবসময় পর্যাপ্ত তাজা পানের জলের ব্যবস্থা রাখতে হবে।`,
        ...
        excerpt: 'বয়স্ক কুকুরের স্পেশাল ডায়েট\n\nসঠিক তথ্যের অভাবে আমরা অনেকেই ভুল করে ফেলি।\n\nসঠিক ডায়েট এবং পুষ্টি তাদের ইমিউন সিস্টেমকে শক্তিশালী করে।\n\nগুরুত্বপূর্ণ ...',
        category: 'Dog Care',
        tags: ['Dog'],
    ...
    },
    {
        ...
        excerpt: 'কুকুরের দাঁতের যত্নে ব্রাশ করার প্রয়োজনীয়তা\n\nবিশেষজ্ঞ ভেটেরিনারিয়ানদের মতে, এই বিষয়টি অত্যন্ত গুরুত্বপূর্ণ।\n\nতাদের সাথে সময় কাটানো এবং খেলাধুলা ক...',
        category: 'Dog Care',
        tags: ['Dog'],
...
কুকুরকে ভালোবাসার মানে তাকে অতিরিক্ত খাওয়ানো নয়, বরং তাকে ফিট এবং সুস্থ রাখা।`,
        ...
        excerpt: 'আপনার কুকুর অতিরিক্ত মোটা হয়ে যাচ্ছে না তো?\n\nসঠিক তথ্যের অভাবে আমরা অনেকেই ভুল করে ফেলি।\n\nকখনও কোনো শারীরিক বা মানসিক পরিবর্তন দেখলে অবহেলা করবেন না।...',
        category: 'Dog Care',
        tags: ['Dog'],
...
**সতর্কতা:** প্রথম রাতে কুকুরছানা কান্না করলে তাকে বকাঝকা করবেন না। একটি টিক-টিক শব্দ করা ঘড়ি বা হালকা গরম পানির বোতল তার বিছানায় রাখলে সে মায়ের উপস্থিতি অনুভব করে শান্ত হতে পারে।`,
    ...
    },
    {
        ...
        excerpt: 'কুকুরের ডিওয়ার্মিং কেন এত জরুরি?\n\nঅনেকেই আমাদের কাছে জানতে চান এই বিষয়টি নিয়ে।\n\nকখনও কোনো শারীরিক বা মানসিক পরিবর্তন দেখলে অবহেলা করবেন না।\n\nগুরুত্বপ...',
        category: 'Dog Care',
        tags: ['Dog'],
...
> ক্লিনিকে অবশ্যই কুকুরকে লিশ (Leash) পরিয়ে রাখবেন। অন্য প্রাণীদের সাথে অকারণে মিশতে দেবেন না, কারণ সেখান থেকে ইনফেকশন ছড়াতে পারে। আপনার কুকুর যদি খুব অ্যাগ্রেসিভ হয়, তবে সেফটির জন্য মাজল (Muzzle) ব্যবহার করতে পারেন।`,
    ...
    },
    {
        ...
        excerpt: 'কুকুরের জন্য বিষাক্ত খাবারগুলোর তালিকা\n\nসঠিক তথ্যের অভাবে আমরা অনেকেই ভুল করে ফেলি।\n\nসঠিক ডায়েট এবং পুষ্টি তাদের ইমিউন সিস্টেমকে শক্তিশালী করে।\n\nগুরু...',
        category: 'Dog Care',
        tags: ['Dog'],
...
ধৈর্য ধরে রুটিন মেনে চললে ধীরে ধীরে কুকুরের চঞ্চলতা নিয়ন্ত্রণে আসবে।`,
        ...
        excerpt: 'কিভাবে কুকুরের হাইপারঅ্যাকটিভিটি নিয়ন্ত্রণ করবেন?\n\nআমাদের প্রতিদিনের ব্যস্ত জীবনে পোষা প্রাণীর যত্ন নেওয়া একটি বড় দায়িত্ব।\n\nকখনও কোনো শারীরিক বা ম...',
        category: 'Dog Care',
        tags: ['Dog'],
    ...
    },
    {
        ...
        excerpt: 'কুকুরের সাধারণ অ্যালার্জি এবং এর ঘরোয়া প্রতিকার\n\nঅনেকেই আমাদের কাছে জানতে চান এই বিষয়টি নিয়ে।\n\nপরিচ্ছন্নতা বজায় রাখা শুধুমাত্র তাদের জন্য নয়, আমাদে...',
        category: 'Dog Care',
        tags: ['Dog'],
...
নিয়মিত অনুশীলনের মাধ্যমে আপনার কুকুর ধীরে ধীরে আরও বেশি আত্মবিশ্বাসী এবং সামাজিক হয়ে উঠবে।`,
        ...
        excerpt: 'কুকুরকে অপরিচিত মানুষের সাথে মিশতে শেখানো\n\nবিশেষজ্ঞ ভেটেরিনারিয়ানদের মতে, এই বিষয়টি অত্যন্ত গুরুত্বপূর্ণ।\n\nতাদের সাথে সময় কাটানো এবং খেলাধুলা করা ত...',
        category: 'Dog Care',
        tags: ['Dog'],
...
৪. **ভয় দেখাবেন না:** কুকুর খাওয়ার সময় তাদের বিরক্ত করবেন না বা গায়ে হাত দিতে যাবেন না।`,
        ...
        excerpt: 'রাস্তার কুকুরকে খাবার দেওয়ার সঠিক নিয়ম\n\nসঠিক তথ্যের অভাবে আমরা অনেকেই ভুল করে ফেলি।\n\nপ্রথমত, তাদের নিয়মিত পর্যবেক্ষণ করতে হবে।\n\nগুরুত্বপূর্ণ কিছু ট...',
        category: 'Dog Care',
        tags: ['Dog'],
    ...
    },
    {
        ...
        excerpt: 'কুকুরের জয়েন্টের ব্যথা: লক্ষণ ও চিকিৎসা\n\nসঠিক তথ্যের অভাবে আমরা অনেকেই ভুল করে ফেলি।\n\nসঠিক ডায়েট এবং পুষ্টি তাদের ইমিউন সিস্টেমকে শক্তিশালী করে।\n\nগু...',
        category: 'Dog Care',
        tags: ['Dog'],
...
**সতর্কতা:** চলন্ত অবস্থায় কুকুরকে জানালার বাইরে মাথা বের করে রাখতে দেবেন না। বাতাসে থাকা ধুলোবালি চোখে গিয়ে মারাত্মক ইনফেকশন হতে পারে বা অন্য গাড়ির সাথে ধাক্কা লাগতে পারে।`,
        ...
        excerpt: 'কুকুরকে গাড়ির ভ্রমণে অভ্যস্ত করানো\n\nআমাদের প্রতিদিনের ব্যস্ত জীবনে পোষা প্রাণীর যত্ন নেওয়া একটি বড় দায়িত্ব।\n\nসঠিক ডায়েট এবং পুষ্টি তাদের ইমিউন সি...',
        category: 'Dog Care',
        tags: ['Dog'],
...
**সতর্কতা:** যদি দাঁত ব্রাশ করার পরও দুর্গন্ধ না যায় বা কুকুরের মাড়ি দিয়ে রক্ত পড়ে, তবে দ্রুত ভেটেরিনারি চিকিৎসকের পরামর্শ নিন। দাঁতের স্কেলিং লাগতে পারে।`,
        ...
        excerpt: 'কুকুরের মুখে দুর্গন্ধ হওয়ার কারণ কী?\n\nসঠিক তথ্যের অভাবে আমরা অনেকেই ভুল করে ফেলি।\n\nপ্রথমত, তাদের নিয়মিত পর্যবেক্ষণ করতে হবে।\n\nগুরুত্বপূর্ণ কিছু টিপস...',
        category: 'Dog Care',
        tags: ['Dog'],
...
ছোট সুতো বা রাবার ব্যান্ড নিয়ে বিড়ালকে খেলতে দেবেন না। এগুলো গিলে ফেললে পেটে গিয়ে আটকে যেতে পারে এবং জীবনঘাতী অবস্থা তৈরি হতে পারে।`,
        ...
        excerpt: 'ইনডোর বিড়ালের জন্য উপযুক্ত খেলনা\n\nঅনেকেই আমাদের কাছে জানতে চান এই বিষয়টি নিয়ে।\n\nসঠিক ডায়েট এবং পুষ্টি তাদের ইমিউন সিস্টেমকে শক্তিশালী করে।\n\nগুরুত্বপ...',
        category: 'Cat Care',
        tags: ['Cat'],
...
আপনার বিড়ালকে নিরাপদ ক্যাট গ্রাস দিন, এটি তাদের শারীরিক ও মানসিক স্বাস্থ্যের জন্য বেশ উপকারী।`,
        ...
        excerpt: 'বিড়াল ঘাস খায় কেন? ক্যাট গ্রাসের উপকারিতা\n\nআমাদের প্রতিদিনের ব্যস্ত জীবনে পোষা প্রাণীর যত্ন নেওয়া একটি বড় দায়িত্ব।\n\nপ্রথমত, তাদের নিয়মিত পর্যবেক...',
        category: 'Cat Care',
        tags: ['Cat'],
...
**টিপস:** একদিনে সব নখ কাটার প্রয়োজন নেই। বিড়াল বিরক্ত হলে ২-৩টি নখ কেটে ছেড়ে দিন, পরে আবার চেষ্টা করুন।`,
        ...
        excerpt: 'বিড়ালের নখ কাটার নিরাপদ উপায়\n\nপোষা প্রাণীদের সুস্থ ও আনন্দময় জীবন নিশ্চিত করতে আমাদের কিছু নিয়ম মেনে চলতে হবে।\n\nপ্রথমত, তাদের নিয়মিত পর্যবেক্ষণ ক...',
        category: 'Cat Care',
        tags: ['Cat'],
...
> ডেলিভারির সময় দূর থেকে নজর রাখুন, অযথা বিরক্ত করবেন না। মা বিড়াল নিজেই সব সামলে নিতে পারে। তবে কোনো জটিলতা (যেমন- অতিরিক্ত রক্তপাত বা বাচ্চা আটকে যাওয়া) দেখলে দ্রুত ভেটকে কল করুন।`,
        ...
        excerpt: 'গর্ভবতী বিড়ালের বিশেষ যত্ন ও খাবার\n\nআমাদের প্রতিদিনের ব্যস্ত জীবনে পোষা প্রাণীর যত্ন নেওয়া একটি বড় দায়িত্ব।\n\nতাদের সাথে সময় কাটানো এবং খেলাধুলা ক...',
        category: 'Cat Care',
        tags: ['Cat'],
...
প্রতিবার খাওয়ানোর পর একটি হালকা গরম ভেজা তুলো দিয়ে ছানার মলদ্বার ও মূত্রনালীর চারপাশে আলতো করে ঘষে দিন। মা বিড়াল চাটলে যেমন হয়, এটি ঠিক তেমন কাজ করে এবং ছানাকে মলমূত্র ত্যাগে সাহায্য করে। এটি না করলে ছানার পেট ফুলে মারা যেতে পারে।`,
        ...
        excerpt: 'নবজাতক বিড়ালছানাকে বোতলে দুধ খাওয়ানোর নিয়ম\n\nআমাদের প্রতিদিনের ব্যস্ত জীবনে পোষা প্রাণীর যত্ন নেওয়া একটি বড় দায়িত্ব।\n\nপরিচ্ছন্নতা বজায় রাখা শুধু...',
        category: 'Cat Care',
        tags: ['Cat'],
...
একেবারেই না। ক্যাটনিপ সম্পূর্ণ প্রাকৃতিক এবং আসক্তি তৈরি করে না (Non-addictive)। তবে অতিরিক্ত খাওয়ালে হালকা ডায়রিয়া হতে পারে। মজার ব্যাপার হলো, সব বিড়াল ক্যাটনিপে সাড়া দেয় না। জেনেটিক কারণে প্রায় ৩০-৫০% বিড়ালের ক্যাটনিপের প্রতি কোনো আকর্ষণ থাকে না।`,
        ...
        excerpt: 'ক্যাটনিপ কী এবং এটি বিড়ালের উপর কেমন প্রভাব ফেলে?\n\nঅনেকেই আমাদের কাছে জানতে চান এই বিষয়টি নিয়ে।\n\nসঠিক ডায়েট এবং পুষ্টি তাদের ইমিউন সিস্টেমকে শক্তিশা...',
        category: 'Cat Care',
        tags: ['Cat'],
...
> প্লাগ-ইন ফোরোমন ডিফিউজার (Pheromone diffuser) ব্যবহার করতে পারেন, যা বিড়ালের মন শান্ত করতে জাদুর মতো কাজ করে।`,
        ...
        excerpt: 'আপনার বিড়াল কি স্ট্রেসে ভুগছে? লক্ষণগুলো জানুন\n\nপোষা প্রাণীদের সুস্থ ও আনন্দময় জীবন নিশ্চিত করতে আমাদের কিছু নিয়ম মেনে চলতে হবে।\n\nসঠিক ডায়েট এবং প...',
        category: 'Cat Care',
        tags: ['Cat'],
...
যদি দেখেন আপনার বিড়াল বারবার বমির চেষ্টা করছে কিন্তু কিছু বের হচ্ছে না, তবে দ্রুত ভেটের কাছে যান। এটি পেটে ব্লকেজ বা বাধা সৃষ্টির লক্ষণ হতে পারে।`,
        ...
        excerpt: 'বিড়ালের হেয়ারবল সমস্যা প্রতিরোধে করণীয়\n\nপোষা প্রাণীদের সুস্থ ও আনন্দময় জীবন নিশ্চিত করতে আমাদের কিছু নিয়ম মেনে চলতে হবে।\n\nপরিচ্ছন্নতা বজায় রাখা ...',
        category: 'Cat Care',
        tags: ['Cat'],
...
সব মিলিয়ে, একটি বিড়াল পালনে গড়ে প্রতি মাসে **১৫০০ থেকে ৩০০০ টাকা** খরচ হতে পারে। মনে রাখবেন, ভালো যত্ন নিলে ভবিষ্যতে চিকিৎসার খরচ অনেক কমে যায়।`,
        ...
        excerpt: 'বিড়াল পালনে মাসিক খরচ কেমন হতে পারে?\n\nবিশেষজ্ঞ ভেটেরিনারিয়ানদের মতে, এই বিষয়টি অত্যন্ত গুরুত্বপূর্ণ।\n\nপ্রথমত, তাদের নিয়মিত পর্যবেক্ষণ করতে হবে।\n\nগ...',
        category: 'Cat Care',
        tags: ['Cat'],
...
> নিজে থেকে মানুষের কোনো ওষুধ বা তেল বিড়ালের কানে দেবেন না। এতে বিড়ালের কানের পর্দা ফেটে গিয়ে বধির হয়ে যাওয়ার ঝুঁকি থাকে।`,
        ...
        excerpt: 'বিড়ালের কানে মাইটস বা পোকা হলে বুঝবেন কীভাবে?\n\nবিশেষজ্ঞ ভেটেরিনারিয়ানদের মতে, এই বিষয়টি অত্যন্ত গুরুত্বপূর্ণ।\n\nপ্রথমত, তাদের নিয়মিত পর্যবেক্ষণ করত...',
        category: 'Cat Care',
        tags: ['Cat'],
...
**সতর্কতা:** শীতকালে বিড়ালকে গোসল করালে খেয়াল রাখবেন যেন তাদের ঠান্ডা না লাগে। হেয়ার ড্রায়ার ব্যবহার করতে পারেন, তবে অনেক বিড়াল এর শব্দে ভয় পায়, তাই লো সেটিংসে ব্যবহার করুন।`,
        ...
        excerpt: 'বিড়ালকে কিভাবে গোসলে অভ্যস্ত করবেন?\n\nসঠিক তথ্যের অভাবে আমরা অনেকেই ভুল করে ফেলি।\n\nকখনও কোনো শারীরিক বা মানসিক পরিবর্তন দেখলে অবহেলা করবেন না।\n\nগুরুত্...',
        category: 'Cat Care',
        tags: ['Cat'],
...
**সতর্কতা:** কুকুর ও বিড়ালের পরিচয়ের ক্ষেত্রে কুকুরকে অবশ্যই লিশ (Leash) পরিয়ে রাখবেন, যেন কুকুর হঠাৎ বিড়ালের ওপর ঝাঁপিয়ে পড়তে না পারে।`,
        ...
        excerpt: 'বিড়ালকে অন্য প্রাণীর সাথে পরিচয় করানোর ধাপ\n\nসঠিক তথ্যের অভাবে আমরা অনেকেই ভুল করে ফেলি।\n\nপ্রথমত, তাদের নিয়মিত পর্যবেক্ষণ করতে হবে।\n\nগুরুত্বপূর্ণ কি...',
        category: 'Cat Care',
        tags: ['Cat'],
...
৬ মাস বয়স পেরোলেই ভেটের পরামর্শ নিয়ে আপনার বিড়ালকে স্পে বা নিউটার করিয়ে নিন। এটি তাদের আয়ু বাড়াতে সাহায্য করে।`,
        ...
        excerpt: 'স্পে বা নিউটারিং কেন বিড়ালের স্বাস্থ্যের জন্য ভালো?\n\nআমাদের প্রতিদিনের ব্যস্ত জীবনে পোষা প্রাণীর যত্ন নেওয়া একটি বড় দায়িত্ব।\n\nপরিচ্ছন্নতা বজায় রা...',
        category: 'Cat Care',
        tags: ['Cat'],
...
* **বছরে একবার চেকআপ:** ভেটের কাছে অ্যানুয়াল চেকআপের সময় অবশ্যই দাঁত চেক করিয়ে নিন। প্রয়োজনে ভেট ডেন্টাল স্কেলিং করে দেবেন।`,
        ...
        excerpt: 'বিড়ালের দাঁতের যত্ন এবং ওরাল হাইজিন\n\nপোষা প্রাণীদের সুস্থ ও আনন্দময় জীবন নিশ্চিত করতে আমাদের কিছু নিয়ম মেনে চলতে হবে।\n\nপরিচ্ছন্নতা বজায় রাখা শুধুম...',
        category: 'Cat Care',
        tags: ['Cat'],
...
- **সতর্কতা:** যদি চোখ থেকে হলুদ বা সবুজ রঙের পুঁজ বের হয় এবং বিড়াল চোখ কুঁচকে রাখে, তবে দ্রুত ভেট দেখান।`,
        ...
        excerpt: 'পার্সিয়ান বিড়ালের চোখ ও লোমের যত্ন\n\nসঠিক তথ্যের অভাবে আমরা অনেকেই ভুল করে ফেলি।\n\nসঠিক ডায়েট এবং পুষ্টি তাদের ইমিউন সিস্টেমকে শক্তিশালী করে।\n\nগুরুত্...',
        category: 'Cat Care',
        tags: ['Cat'],
...
যেকোনো ক্লিনিকে যাওয়ার আগে অবশ্যই ফোন করে অ্যাপয়েন্টমেন্ট করে নিন বা তাদের খোলার সময় সম্পর্কে নিশ্চিত হোন, বিশেষ করে সরকারি ছুটির দিনগুলোতে।`,
        ...
        excerpt: 'ঢাকায় অবস্থিত সেরা ৫টি ভেটেরিনারি ক্লিনিক\n\nসঠিক তথ্যের অভাবে আমরা অনেকেই ভুল করে ফেলি।\n\nপ্রথমত, তাদের নিয়মিত পর্যবেক্ষণ করতে হবে।\n\nগুরুত্বপূর্ণ কিছু...',
        category: 'General Pet Care',
        tags: ['General'],
...
আপনার আশেপাশে ভালো পশু চিকিৎসক বা ক্লিনিক আছে কিনা তা আগে থেকেই খোঁজ নিয়ে রাখুন। ইমার্জেন্সিতে এটি খুব কাজে দেবে।`,
        ...
        excerpt: 'পোষা প্রাণী দত্তক নেওয়ার আগে যে ৫টি কথা ভাববেন\n\nবিশেষজ্ঞ ভেটেরিনারিয়ানদের মতে, এই বিষয়টি অত্যন্ত গুরুত্বপূর্ণ।\n\nতাদের সাথে সময় কাটানো এবং খেলাধু...',
        category: 'General Pet Care',
        tags: ['General'],
...
সাধারণত কুকুর বা বিড়ালছানার বয়স ৬ থেকে ৮ সপ্তাহ হলে প্রথম টিকা দিতে হয়। এরপর ভেটের পরামর্শ অনুযায়ী বুস্টার ডোজ এবং প্রতি বছর একটি করে অ্যানুয়াল শট দিতে হয়। টিকা দেওয়ার কার্ডটি সবসময় যত্ন করে রাখবেন।`,
        ...
        excerpt: 'ভ্যাকসিনেশন: কেন এটি আপনার পোষ্যর জন্য অত্যাবশ্যকীয়?\n\nবিশেষজ্ঞ ভেটেরিনারিয়ানদের মতে, এই বিষয়টি অত্যন্ত গুরুত্বপূর্ণ।\n\nপ্রথমত, তাদের নিয়মিত পর্যবেক...',
        category: 'General Pet Care',
        tags: ['General'],
...
প্রতিটি এয়ারলাইন্সের নিয়ম ভিন্ন। কিছু এয়ারলাইন্স ছোট প্রাণীকে কেবিনে (মালিকের সাথে সিটের নিচে) নেওয়ার অনুমতি দেয়, আবার কিছু এয়ারলাইন্স কার্গো হোল্ডে পাঠাতে বলে। টিকিট কাটার আগে অবশ্যই এয়ারলাইন্সের সাথে বিস্তারিত কথা বলে নিন।`,
        ...
        excerpt: 'পোষা প্রাণীর পাসপোর্ট এবং ট্রাভেলিং নিয়মকানুন\n\nবিশেষজ্ঞ ভেটেরিনারিয়ানদের মতে, এই বিষয়টি অত্যন্ত গুরুত্বপূর্ণ।\n\nতাদের সাথে সময় কাটানো এবং খেলাধুলা ...',
        category: 'General Pet Care',
        tags: ['General'],
...
প্রতিবেশীদের সুবিধার কথা মাথায় রেখে প্রাণীকে অযথা শব্দ করা থেকে বিরত রাখতে ট্রেনিং দিন।`,
        ...
        excerpt: 'ফ্ল্যাট বাসায় পোষা প্রাণী রাখার ক্ষেত্রে কিছু জরুরি টিপস\n\nআমাদের প্রতিদিনের ব্যস্ত জীবনে পোষা প্রাণীর যত্ন নেওয়া একটি বড় দায়িত্ব।\n\nসঠিক ডায়েট এবং...',
        category: 'General Pet Care',
        tags: ['General'],
...
কখনোই আশা ছাড়বেন না। অনেক প্রাণী কয়েক সপ্তাহ এমনকি মাসখানেক পরেও ফিরে আসে।`,
        ...
        excerpt: 'কীভাবে আপনার হারিয়ে যাওয়া পোষা প্রাণীকে খুঁজবেন?\n\nআমাদের প্রতিদিনের ব্যস্ত জীবনে পোষা প্রাণীর যত্ন নেওয়া একটি বড় দায়িত্ব।\n\nপরিচ্ছন্নতা বজায় রাখা...',
        category: 'General Pet Care',
        tags: ['General'],
...
একটি প্রাণীকে রাস্তা থেকে বাসায় আনার পর সবার আগে তাকে একজন ভেটের কাছে নিয়ে যান। তার স্বাস্থ্য পরীক্ষা, ডিওয়ার্মিং (কৃমিনাশক) এবং প্রয়োজনীয় ভ্যাক্সিনেশন সম্পন্ন করুন। নতুন পরিবেশে মানিয়ে নিতে তাকে সময় ও স্পেস দিন।`,
        ...
        excerpt: 'রেসকিউ এনিম্যাল: একটি প্রাণীকে নতুন জীবন দিন\n\nআমাদের প্রতিদিনের ব্যস্ত জীবনে পোষা প্রাণীর যত্ন নেওয়া একটি বড় দায়িত্ব।\n\nসঠিক ডায়েট এবং পুষ্টি তাদের...',
        category: 'General Pet Care',
        tags: ['General'],
...
> ইমার্জেন্সি ভেটেরিনারি ক্লিনিকের ফোন নম্বর এবং ঠিকানা একটি কাগজে লিখে কিটের ভেতরে রাখুন, যাতে বিপদের সময় খুঁজতে না হয়।`,
        ...
        excerpt: 'পোষা প্রাণীর ফার্স্ট এইড কিট কীভাবে তৈরি করবেন?\n\nঅনেকেই আমাদের কাছে জানতে চান এই বিষয়টি নিয়ে।\n\nপ্রথমত, তাদের নিয়মিত পর্যবেক্ষণ করতে হবে।\n\nগুরুত্বপূর্...',
        category: 'General Pet Care',
        tags: ['General'],
...
> যদি আপনার প্রাণী অতিরিক্ত ভয় পায় বা প্যানিক অ্যাটাক করে, তবে আগে থেকেই ভেটের সাথে কথা বলে অ্যান্টি-অ্যাংজাইটি ওষুধ (যদি ভেট প্রেসক্রাইব করেন) প্রস্তুত রাখুন।`,
        ...
        excerpt: 'ঈদের সময় পশু কোরবানির গন্ধে পোষা প্রাণীকে শান্ত রাখবেন কীভাবে?\n\nপোষা প্রাণীদের সুস্থ ও আনন্দময় জীবন নিশ্চিত করতে আমাদের কিছু নিয়ম মেনে চলতে হবে।\n\nত...',
        category: 'General Pet Care',
        tags: ['General'],
...
একেবারেই না। এটি সাধারণ ভ্যাকসিন দেওয়ার মতোই। এতে কয়েক সেকেন্ড সময় লাগে এবং প্রাণীকে অজ্ঞান করার কোনো প্রয়োজন হয় না। আপনার স্থানীয় ভেটের সাথে আজই মাইক্রোচিপিং নিয়ে কথা বলুন।`,
        ...
        excerpt: 'পোষা প্রাণীর জন্য মাইক্রোচিপিং: সুবিধা ও প্রক্রিয়া\n\nপোষা প্রাণীদের সুস্থ ও আনন্দময় জীবন নিশ্চিত করতে আমাদের কিছু নিয়ম মেনে চলতে হবে।\n\nকখনও কোনো শার...',
        category: 'General Pet Care',
        tags: ['General'],
...
সামান্য সঞ্চয় বিপদের সময় আপনার প্রিয় প্রাণীর জীবন বাঁচাতে পারে।`,
        ...
        excerpt: 'কীভাবে পোষা প্রাণীর ইনস্যুরেন্স বা হেলথ ফান্ড গঠন করবেন?\n\nবিশেষজ্ঞ ভেটেরিনারিয়ানদের মতে, এই বিষয়টি অত্যন্ত গুরুত্বপূর্ণ।\n\nপরিচ্ছন্নতা বজায় রাখা শুধ...',
        category: 'General Pet Care',
        tags: ['General'],
...
আপনার প্রাণীকে নিয়ে সুন্দর সময় কাটানোর জন্য এই জায়গাগুলো দারুণ একটি অভিজ্ঞতা হতে পারে।`,
        ...
        excerpt: 'বাংলাদেশে পেট ফ্রেন্ডলি ক্যাফে এবং রেস্তোরাঁ\n\nবিশেষজ্ঞ ভেটেরিনারিয়ানদের মতে, এই বিষয়টি অত্যন্ত গুরুত্বপূর্ণ।\n\nকখনও কোনো শারীরিক বা মানসিক পরিবর্তন দ...',
        category: 'General Pet Care',
        tags: ['General'],
...
> প্রাণী ভয় পেলে তাকে বকাবকি করবেন না। আপনি নিজে শান্ত থাকুন এবং স্বাভাবিক আচরণ করুন। আপনার আতঙ্ক প্রাণীকে আরও ভয় পাইয়ে দেবে।`,
        ...
        excerpt: 'বজ্রপাত বা আতশবাজির শব্দে পোষা প্রাণীর ভয় কাটাবেন কীভাবে?\n\nআমাদের প্রতিদিনের ব্যস্ত জীবনে পোষা প্রাণীর যত্ন নেওয়া একটি বড় দায়িত্ব।\n\nতাদের সাথে সময...',
        category: 'General Pet Care',
        tags: ['General'],
...
> পেঁয়াজ, রসুন, চকলেট, এবং আঙুর কুকুর-বিড়ালের জন্য মারাত্মক বিষাক্ত। রান্নার সময় এগুলো থেকে ১০০ হাত দূরে থাকুন।`,
        ...
        excerpt: 'পোষা প্রাণীর খাবার বাড়িতে তৈরি করার কিছু রেসিপি\n\nপোষা প্রাণীদের সুস্থ ও আনন্দময় জীবন নিশ্চিত করতে আমাদের কিছু নিয়ম মেনে চলতে হবে।\n\nকখনও কোনো শারীরি...',
        category: 'General Pet Care',
        tags: ['General'],
...
> প্রাণী ছোঁয়ার পর সাবান দিয়ে ভালোভাবে হাত ধুয়ে ফেলুন এবং হাত না ধুয়ে চোখ বা মুখ স্পর্শ করবেন না। প্রয়োজনে চিকিৎসকের পরামর্শ নিয়ে অ্যান্টি-অ্যালার্জি ওষুধ সাথে রাখতে পারেন।`,
        ...
        excerpt: 'কীভাবে পোষা প্রাণীর অ্যালার্জি থেকে নিজে সুরক্ষিত থাকবেন?\n\nবিশেষজ্ঞ ভেটেরিনারিয়ানদের মতে, এই বিষয়টি অত্যন্ত গুরুত্বপূর্ণ।\n\nকখনও কোনো শারীরিক বা মানস...',
        category: 'General Pet Care',
        tags: ['General'],
...
সঠিক দিকনির্দেশনায় একটি পোষা প্রাণী আপনার সন্তানের সেরা বন্ধু হয়ে উঠতে পারে।`,
        ...
        excerpt: 'আপনার সন্তানের সাথে পোষা প্রাণীর বন্ধুত্বপূর্ণ সম্পর্ক তৈরি\n\nসঠিক তথ্যের অভাবে আমরা অনেকেই ভুল করে ফেলি।\n\nপরিচ্ছন্নতা বজায় রাখা শুধুমাত্র তাদের জন্য ...',
        category: 'General Pet Care',
        tags: ['General'],
...
আপনার বাজেট এবং প্রাণীর লোমের ধরন অনুযায়ী আপনি যেকোনো একটি বেছে নিতে পারেন। মাসে একবার স্যালনে নেওয়া এবং বাকি দিনগুলোতে বাড়িতে ব্রাশ করা একটি ভালো রুটিন হতে পারে।`,
        ...
        excerpt: 'গ্রুমিং স্যালন বনাম বাড়িতে গ্রুমিং: কোনটি ভালো?\n\nপোষা প্রাণীদের সুস্থ ও আনন্দময় জীবন নিশ্চিত করতে আমাদের কিছু নিয়ম মেনে চলতে হবে।\n\nসঠিক ডায়েট এবং ...',
        category: 'General Pet Care',
        tags: ['General'],
...
**জরুরি সতর্কতা:** যদি বুঝতে পারেন কুকুরের হিটস্ট্রোক হয়েছে, তবে দ্রুত তার গায়ে ও মাথায় সাধারণ তাপমাত্রার পানি ঢালুন (বরফ পানি নয়) এবং সাথে সাথে ভেটের কাছে নিয়ে যান।`,
        ...
        excerpt: 'গরমকালে পোষ্যের হিটস্ট্রোক থেকে বাঁচার উপায়\n\nঅনেকেই আমাদের কাছে জানতে চান এই বিষয়টি নিয়ে।\n\nপ্রথমত, তাদের নিয়মিত পর্যবেক্ষণ করতে হবে।\n\nগুরুত্বপূর্ণ ক...',
        category: 'General Pet Care',
        tags: ['General'],
...
> গাছ নিরাপদ হলেও প্রাণীদের মাটি খোঁড়া বা পাতা চিবানোর অভ্যাস থাকে। তাই গাছগুলোকে কিছুটা উঁচুতে বা হ্যাঙ্গিং পটে রাখা ভালো।`,
        ...
        excerpt: 'পোষা প্রাণীর জন্য নিরাপদ কিছু ইনডোর প্ল্যান্ট\n\nঅনেকেই আমাদের কাছে জানতে চান এই বিষয়টি নিয়ে।\n\nসঠিক ডায়েট এবং পুষ্টি তাদের ইমিউন সিস্টেমকে শক্তিশালী কর...',
        category: 'General Pet Care',
        tags: ['General'],
...
exports.MOCK_ANIMALS = [
    {
        ...
        status: 'available',
        description: 'A lovely fluffy Persian cat looking for a forever home. Very friendly and great with kids.',
        sex: 'Female',
        color: 'White',
        vaccinated: true,
        spayedNeutered: true,
