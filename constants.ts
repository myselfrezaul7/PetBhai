...
export const MOCK_BRANDS: Brand[] = [
  ...
  { id: 4, name: 'Me-O', logoUrl: 'https://i.ibb.co/Y0M4yC4/meo-logo.png' },
  {
    ...
    name: 'Whiskas',
    logoUrl:
      'https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/Whiskas_Logo.svg/2560px-Whiskas_Logo.svg.png',
  },
  {
    id: 6,
    name: 'SmartHeart',
    logoUrl: 'https://smartheart-bf83.kxcdn.com/wp-content/themes/smartheart/images/logo.png',
  },
  {
    id: 7,
    name: 'Lara',
    logoUrl: 'https://www.versele-laga.com/themes/verselelaga/assets/img/brand-logos/lara.svg',
  },
  {
    id: 8,
    name: 'Kaniva',
    logoUrl: 'https://www.petshopbd.com/images/brands/kaniva.png',
  },
  {
    id: 9,
    name: 'Reflex Plus',
    logoUrl: 'https://www.petshopbd.com/images/brands/reflex_plus.png',
  },
  {
    id: 10,
    name: 'Spectrum',
    logoUrl: 'https://www.petshopbd.com/images/brands/spectrum.png',
  },
  {
    id: 11,
    name: 'Trendline',
    logoUrl: 'https://www.petshopbd.com/images/brands/trendline.png',
  },
  {
    id: 12,
    name: 'Harvest Luck',
    logoUrl: 'https://www.petshopbd.com/images/brands/harvest_luck.png',
  },
  {
    id: 13,
    name: 'Bonnie',
    logoUrl: 'https://www.petshopbd.com/images/brands/bonnie.png',
  },
  {
    id: 14,
    name: 'Reflex',
    logoUrl: 'https://www.petshopbd.com/images/brands/reflex.png',
  },
  {
    id: 15,
    name: 'JerHigh',
    logoUrl: 'https://www.petshopbd.com/images/brands/jerhigh.png',
  },
  {
    id: 16,
    name: 'PetBhai Essentials',
    logoUrl: 'https://picsum.photos/seed/brand16/100/100',
  },
];
...
export const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: [],
    searchTags: ['kaniva', 'cat food', 'chicken', 'tuna', 'rice', 'biral', 'khabar', 'shiny coat'],
  },
  {
    id: 15,
    ...
    rating: 4.7,
    reviews: [],
    searchTags: ['reflex', 'plus', 'cat food', 'chicken', 'biral', 'khabar', 'reflex plus'],
  },
  {
    id: 16,
    ...
    rating: 4.6,
    reviews: [],
    searchTags: ['spectrum', 'cat food', 'low grain', 'biral', 'khabar', 'sensitive'],
  },
  {
    id: 17,
    ...
    rating: 4.2,
    reviews: [],
    searchTags: ['trendline', 'cat food', 'chicken', 'biral', 'khabar', 'budget'],
  },
  {
    id: 18,
    ...
    rating: 4.5,
    reviews: [],
    searchTags: ['harvest', 'luck', 'cat food', 'biral', 'khabar', 'premium'],
  },
  {
    id: 19,
